...
class FeatPicBoxes extends PageLinesSection {
	...
	*/
	function draw_boxes($p, $args){ 
		...
		return sprintf('<div id="%s" class="fbox %s"><div class="imagecontainer" style="background-image:url(\'%s\');"></div><div class="shading"></div>%s</div>', 'fbox_'.$p->ID, $class, $box_icon, $title_text);
